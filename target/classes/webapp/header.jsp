...
// ✅ ADDED: Get wishlist count for customer
int wishlistCount = 0;
try {
    WishlistServiceImpl wishlistService = new WishlistServiceImpl();
    wishlistCount = wishlistService.getWishlistCount((String) session.getAttribute("username"));
} catch (Exception e) {
    wishlistCount = 0; // Default to 0 if service not available
}
%>
<nav class="navbar navbar-default navbar-fixed-top">
...
<!-- ✅ ADDED: Wishlist Section with Counter -->
<%
if (wishlistCount == 0) {
%>
...
%>
<li><a href="wishlist.jsp" style="position: relative;">
    <span class="glyphicon glyphicon-heart" style="color: #e74c3c;"></span>&nbsp;Wishlist
    <span class="badge" style="position: absolute; top: -5px; right: -10px; background-color: #e74c3c; font-size: 10px;"><%=wishlistCount%></span>
</a></li>
<%
}
%>
